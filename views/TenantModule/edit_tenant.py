...
class EditTenantView(QDialog):
    def __init__(self, tenant_data, parent=None):
        ...
        # Set styles for labels, placeholders, and input values
        self.setStyleSheet("""
            QLabel { font-size: 16px; font-Weight:bold; }
            QLineEdit { font-size: 14px; }
            QLineEdit::placeholder { color: grey; font-size: 14px; }
        ...
        tenant_label = QLabel(f"Editing Tenant: {tenant_full_name}")
        tenant_label.setStyleSheet("font-weight: bold; font-size: 16px;")
    ...
    def save_tenant(self):
        ...
        from controllers.PostGreSqlControllers.tenant_controller import update_tenant
        try:
