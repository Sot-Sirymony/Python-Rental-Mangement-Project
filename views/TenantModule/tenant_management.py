...
class TenantManagement(QWidget):
    ...
    def load_tenants(self):
        ...
        from controllers.PostGreSqlControllers.tenant_controller import fetch_tenants, delete_tenant
    ...
    def search_tenants(self, search_text):
        ...
        from controllers.PostGreSqlControllers.tenant_controller import fetch_tenants
        tenants = fetch_tenants()
        filtered_tenants = [
    ...
    def delete_tenant_action(self, tenant_id):
        """Delete a tenant."""
        from controllers.PostGreSqlControllers.tenant_controller import delete_tenant
        try:
