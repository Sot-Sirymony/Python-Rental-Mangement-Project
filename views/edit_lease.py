...
class EditLeaseView(QDialog):
    def __init__(self, lease_data, parent=None):
        ...
        self.setWindowTitle(f"Edit Lease for Room {lease_data['room_name']}")
        ...
        self.start_date.setDate(QDate.fromString(lease_data['start_date'], "yyyy-MM-dd"))
        ...
        self.end_date.setDate(QDate.fromString(lease_data['end_date'], "yyyy-MM-dd"))
        self.layout.addWidget(self.end_date)

        # Payment Terms (Editable)
        self.layout.addWidget(QLabel("Payment Terms"))
        self.payment_terms = QLineEdit()
        self.payment_terms.setText(lease_data['payment_terms'])
    ...
    def update_lease(self):
        ...
        try:
            update_lease(self.lease_id, end_date, payment_terms)
